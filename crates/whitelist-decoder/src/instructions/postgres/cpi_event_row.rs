...
impl CpiEventRow {
    pub fn from_parts(source: CpiEvent, metadata: InstructionMetadata) -> Self {
        Self {
            ...
            name: match &source {
                                CpiEvent::AdminRegistered(_) => "admin_registered".to_string(),
                                CpiEvent::AdminRemoved(_) => "admin_removed".to_string(),
                                ...
                                CpiEvent::PermissionUpdated(_) => "permission_updated".to_string(),
                                CpiEvent::RoleAssigned(_) => "role_assigned".to_string(),
                                CpiEvent::RoleRemoved(_) => "role_removed".to_string(),
                            },
