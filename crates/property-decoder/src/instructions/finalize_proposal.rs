...
impl FinalizeProposal {
    pub fn decode(data: &[u8]) -> Option<Self> {
        ...
        if discriminator != &[23, 68, 51, 167, 109, 173, 187, 164] {
            return None;
        }
...
impl ArrangeAccounts for FinalizeProposal {
    type ArrangedAccounts = FinalizeProposalInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(FinalizeProposalInstructionAccounts {
            cranker,
            rent_payer,
            letting,
            property,
