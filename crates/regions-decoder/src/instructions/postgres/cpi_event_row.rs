    ...
    pub fn from_parts(source: CpiEvent, metadata: InstructionMetadata) -> Self {
        Self {
            ...
            name: match &source {
                                ...
                                CpiEvent::ListingDurationChanged(_) => "listing_duration_changed".to_string(),
                                CpiEvent::LocationCreated(_) => "location_created".to_string(),
                                CpiEvent::LocationRemoved(_) => "location_removed".to_string(),
                                CpiEvent::RegionClaimed(_) => "region_claimed".to_string(),
                                CpiEvent::RegionCreated(_) => "region_created".to_string(),
                                CpiEvent::RegionProposalPassed(_) => "region_proposal_passed".to_string(),
                                CpiEvent::RegionProposalRejected(_) => "region_proposal_rejected".to_string(),
                                CpiEvent::RegionProposed(_) => "region_proposed".to_string(),
                                CpiEvent::RegionStateCleared(_) => "region_state_cleared".to_string(),
                                CpiEvent::RegionTaxChanged(_) => "region_tax_changed".to_string(),
                                CpiEvent::ResignationInitiated(_) => "resignation_initiated".to_string(),
                                CpiEvent::VotedOnRegionProposal(_) => "voted_on_region_proposal".to_string(),
                                CpiEvent::VotingTokenUnlocked(_) => "voting_token_unlocked".to_string(),
                            },
