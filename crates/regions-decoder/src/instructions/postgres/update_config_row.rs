...
impl UpdateConfigRow {
    pub fn from_parts(source: crate::instructions::update_config::UpdateConfig, metadata: InstructionMetadata) -> Self {
        Self {
...
impl carbon_core::postgres::operations::Delete for UpdateConfigRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(r#"DELETE FROM update_config_instruction WHERE
...
impl carbon_core::postgres::operations::LookUp for UpdateConfigRow {
    ...
    async fn lookup(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<Option<Self>> {
        let row = sqlx::query_as(r#"SELECT * FROM update_config_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#)
        .bind(key.0)
        .bind(key.1)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for UpdateConfigMigrationOperation {
    async fn up(&self, connection: &mut sqlx::PgConnection) -> Result<(), sqlx_migrator::error::Error> {
        sqlx::query(r#"CREATE TABLE IF NOT EXISTS update_config_instruction (
                -- Instruction data
    ...
    async fn down(&self, connection: &mut sqlx::PgConnection) -> Result<(), sqlx_migrator::error::Error> {
        sqlx::query(r#"DROP TABLE IF EXISTS update_config_instruction"#).execute(connection).await?;
        Ok(())
    }
}
