...
impl CpiEventRow {
    pub fn from_parts(source: CpiEvent, metadata: InstructionMetadata) -> Self {
        Self {
            ...
            name: match &source {
                                CpiEvent::HubCreated(_) => "hub_created".to_string(),
                                CpiEvent::IncomeClaimed(_) => "income_claimed".to_string(),
                                CpiEvent::SaleRecorded(_) => "sale_recorded".to_string(),
                                CpiEvent::SharesBought(_) => "shares_bought".to_string(),
                                CpiEvent::SharesDelisted(_) => "shares_delisted".to_string(),
                                CpiEvent::SharesListed(_) => "shares_listed".to_string(),
                            },
